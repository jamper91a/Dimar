...
import static com.sbi.dimar.visitaoficialarribooffline.app.database.entities.PracticalPilotAsistentsEntity.PRACTICAL_PILOT_ASISTENTS_BD;
 ...
 */
public class PracticalPilotAsistentsDAOImpl extends AbstractFacade implements PracticalPilotAsistentsDAO {

    private static final String TAG = PracticalPilotAsistentsDAOImpl.class.getSimpleName();
    ...
    public PracticalPilotAsistentsDAOImpl(SQLiteDatabase sqLiteDatabase, List<PracticalPilotTO> practicalPilotTOS) {
        super(PRACTICAL_PILOT_ASISTENTS_BD.table(), PRACTICAL_PILOT_ASISTENTS_BD.columnsWhitValues(practicalPilotTOS), PRACTICAL_PILOT_ASISTENTS_BD.columnsNames());
